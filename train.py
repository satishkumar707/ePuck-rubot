"""
TODO / NOTES
[ ] clipping node: can (and will) be added to the end of each sfa_over_node of 
	the hierarchical layers. They are needed when the training data differs 
	significantly from the testing data. The clip value can be determined 
	epmirically or set to ~95% of the training data (whut?! see Franzius mail
	from 16th Nov 2011)
	-> implement & store away for the moment
"""
